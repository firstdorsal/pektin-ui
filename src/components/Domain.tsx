...
export default class Domain extends Component<DomainProps, DomainState> {
  ...
  componentDidMount = async () => {
    if (this.props.variant === "import") {
      ...
      const records = await l.getAllRecords(this.props.config, this.props.match.params.domainName);
      ...
      >
        ...
        >
          <Fab
            ...
            size="small"
            className={
              this.state.errorRecords ? "error" : this.state.warningRecords ? "warning" : ""
            }
          >
